...
Сформирован UTC: `2026-09-05T14:59:36.664607+00:00`. Аудит read-only; существующие файлы не перезаписываются.
...
| Адаптивность регионов (0–5) | **готово** | batch anomaly, reproducibility audit, new-test manifest |
...
Полный машиночитаемый результат: `reports/criteria_readiness_audit_20260905_145901.json`.
